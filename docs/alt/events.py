...
def StreamSyncedMetaChange(entity: Entity, key: str, value: str, old_value: str) -> None: ...
...
def PlayerDamage(victim: Player, attacker: Entity, health_damage: int, armour_damage: int, weapon_hash: int) -> None: ...
def PlayerDeath(victim: Player, killer: Entity, weapon_hash: int) -> None: ...
def Fire(player: Player, fires: FireInfo) -> bool | None: ...
def Explosion(source: Player, type: ExplosionType, pos: Vector3, fx: int, target: Entity) -> bool | None: ...
def StartProjectile(player: Player, pos: Vector3, dir: Vector3, ammo_hash: int, weapon_hash: int) -> bool | None: ...
def WeaponDamage(source: Player, target: Entity, weapon_hash: int, damage: int, offset: Vector3, body_part: BodyPart) -> bool | None: ...
def VehicleDestroy(vehicle: Vehicle) -> None: ...
def VehicleDamage(vehicle: Vehicle, attacker: Entity, body_health_damage: int, additional_body_health_damage: int, engine_health_damage: int, petrol_tank_damage: int, weapon: int) -> None: ...
...
def PlayerChangeVehicleSeat(player: Player, vehicle: Vehicle, old_seat: int, seat: int) -> None: ...
