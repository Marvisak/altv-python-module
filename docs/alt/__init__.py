...
class Entity(WorldObject):
	...
	def attach_to(self, entity: Entity, entity_bone_id: int, own_bone_id: int, pos: Vector3, rot: Vector3, enable_collisions: bool, no_fixed_rotation: bool) -> None:
...
class Player(Entity):
	...
	def set_dlc_clothes(self, dlc: int, component: int, drawable: int, texture: int, palette: int = 2) -> bool:
