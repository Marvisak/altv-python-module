...
class DlcClothes
{
 ...
 public:
	...
	DlcClothes(uint32_t dlc, uint16_t drawable, uint8_t texture, uint8_t palette)
		: dlc(dlc), drawableId(drawable), textureId(texture), paletteId(palette)
	{
	}
	DlcClothes(alt::DlcCloth dlcCloth)
		: dlc(dlcCloth.dlc), drawableId(dlcCloth.drawableId), textureId(dlcCloth.textureId), paletteId(dlcCloth.paletteId)
	{
	}
