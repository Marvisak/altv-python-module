...
class Clothes
{
 ...
 public:
	...
	Clothes(uint16_t drawable, uint8_t texture, uint8_t palette)
		: drawableId(drawable), textureId(texture), paletteId(palette)
	{
	}
	Clothes(alt::Cloth cloth)
		: drawableId(cloth.drawableId), textureId(cloth.textureId), paletteId(cloth.paletteId)
	{
	}
