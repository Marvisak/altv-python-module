...
void RegisterColShapeClass(const py::module_& m)
{
	...
	pyClass.def_static(
		"cylinder", [](double x, double y, double z, float radius, float height) {
	...
	pyClass.def_static(
		"sphere", [](double x, double y, double z, float radius) {
	...
	pyClass.def_static(
		"cube", [](Vector3 pos1, Vector3 pos2) {
