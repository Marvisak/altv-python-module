...
class WorldObject : public BaseObject
{
 ...
 public:
	WorldObject(alt::Ref<alt::IWorldObject> worldObject)
		: worldObject(worldObject), BaseObject(worldObject)
	{
	}
	...
	{
		worldObject->SetPosition(pos.toAltPos());
	}
	...
	void SetDimension(int32_t dimension) const
	{
