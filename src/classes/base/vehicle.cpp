...
void RegisterVehicleClass(const py::module_& m)
{
	...
	// Train properties
	pyClass.def_property("isMissionTrain", &Vehicle::IsTrainMissionTrain, &Vehicle::SetTrainMissionTrain);
	pyClass.def_property("trainTrackId", &Vehicle::GetTrainTrackId, &Vehicle::SetTrainTrackId);
	pyClass.def_property_readonly("getTrainEngineId", &Vehicle::GetTrainEngineId);
	pyClass.def_property("trainConfigIndex", &Vehicle::GetTrainConfigIndex, &Vehicle::SetTrainConfigIndex);
	pyClass.def_property("trainDistanceFromEngine", &Vehicle::GetTrainDistanceFromEngine, &Vehicle::SetTrainDistanceFromEngine);
	pyClass.def_property("isTrainEngine", &Vehicle::IsTrainEngine, &Vehicle::SetTrainEngine);
	pyClass.def_property("isTrainCaboose", &Vehicle::IsTrainCaboose, &Vehicle::SetTrainCaboose);
	pyClass.def_property("trainDirection", &Vehicle::GetTrainDirection, &Vehicle::SetTrainDirection);
	pyClass.def_property("trainPassengerCarriages", &Vehicle::HasTrainPassengerCarriages, &Vehicle::SetTrainHasPassengerCarriages);
	pyClass.def_property("trainRenderDerailed", &Vehicle::GetTrainRenderDerailed, &Vehicle::SetTrainRenderDerailed);
	pyClass.def_property("trainForceDoorsOpen", &Vehicle::GetTrainForceDoorsOpen, &Vehicle::SetTrainForceDoorsOpen);
	pyClass.def_property("trainCruiseSpeed", &Vehicle::GetTrainCruiseSpeed, &Vehicle::SetTrainCruiseSpeed);
	pyClass.def_property("trainCarriageConfigIndex", &Vehicle::GetTrainCarriageConfigIndex, &Vehicle::SetTrainCarriageConfigIndex);
	pyClass.def_property("trainLinkedToBackwardId", &Vehicle::GetWindowTint, &Vehicle::SetWindowTint);
	pyClass.def_property("trainLinkedToForwardId", &Vehicle::GetWindowTint, &Vehicle::SetWindowTint);
	pyClass.def_property_readonly("trainLinkedToBackwardId", &Vehicle::GetTrainLinkedToBackwardId);
	pyClass.def_property_readonly("trainLinkedToForwardId", &Vehicle::GetTrainLinkedToForwardId);
	pyClass.def("setTrainLinkedToBackwardId", &Vehicle::SetTrainLinkedToBackwardId);
	pyClass.def("setTrainLinkedToForwardId", &Vehicle::SetTrainLinkedToForwardId);
	pyClass.def("setTrainEngineId", &Vehicle::setTrainEngineId);
