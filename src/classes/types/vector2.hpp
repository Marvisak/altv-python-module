...
class Vector2
{
 ...
 public:
	...
	explicit Vector2(alt::Position position)
		: x{position[0]}, y{position[1]}
	{
	}
	explicit Vector2(alt::Rotation rotation)
		: x{rotation[0]}, y{rotation[1]}
	{
	}
	explicit Vector2(alt::Vector2f vector)
		: x{vector[0]}, y{vector[1]}
	{
	}
	explicit Vector2(const py::list& vectorList)
		: x{vectorList[0].cast<float>()}, y{vectorList[1].cast<float>()}
	{
	}
